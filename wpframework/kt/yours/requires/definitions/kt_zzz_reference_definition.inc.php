...
function kt_zzz_register_reference_post_type()
{
    $labels = [
        ...
        "archives" => __("Archív referencí", "ZZZ_DOMAIN"),
        "attributes" => __("Atributy", "ZZZ_DOMAIN"),
        "parent_item_colon" => __("Nadřazená reference", "ZZZ_DOMAIN"),
        "all_items" => __("Všechny reference", "ZZZ_DOMAIN"),
        "add_new_item" => __("Přidat novou referenci", "ZZZ_DOMAIN"),
        "add_new" => __("Přidat novou", "ZZZ_DOMAIN"),
        "new_item" => __("Přidat referenci", "ZZZ_DOMAIN"),
        "edit_item" => __("Upravit referenci", "ZZZ_DOMAIN"),
        "update_item" => __("Aktualizovat referenci", "ZZZ_DOMAIN"),
        "view_item" => __("Zobrazit referenci", "ZZZ_DOMAIN"),
        "view_items" => __("Zobrazit reference", "ZZZ_DOMAIN"),
        "search_items" => __("Hledat reference", "ZZZ_DOMAIN"),
        "not_found" => __("Nenalezeno", "ZZZ_DOMAIN"),
        "not_found_in_trash" => __("Nenalezeno v koši", "ZZZ_DOMAIN"),
        "featured_image" => __("Obrázek", "ZZZ_DOMAIN"),
        "set_featured_image" => __("Zvolit obrázek", "ZZZ_DOMAIN"),
        "remove_featured_image" => __("Odstranit obrázek", "ZZZ_DOMAIN"),
        "use_featured_image" => __("Zvolit obrázek", "ZZZ_DOMAIN"),
        "insert_into_item" => __("Vložit k referenci", "ZZZ_DOMAIN"),
        "uploaded_to_this_item" => __("Nahrát k referenci", "ZZZ_DOMAIN"),
        "items_list" => __("Seznam referencí", "ZZZ_DOMAIN"),
        "items_list_navigation" => __("Seznam referencí menu", "ZZZ_DOMAIN"),
        "filter_items_list" => __("Filtrovat reference", "ZZZ_DOMAIN"),
    ];
    $args = [
        "label" => __("Reference", "ZZZ_DOMAIN"),
        "description" => __("Entita reference", "ZZZ_DOMAIN"),
        "labels" => $labels,
        "public" => true,
...
{
    $labels = [
        "name" => __("Kategorie", "ZZZ_DOMAIN"),
        "singular_name" => __("Kategorie", "ZZZ_DOMAIN"),
        "menu_name" => __("Kategorie", "ZZZ_DOMAIN"),
        "all_items" => __("Všechny kategorie", "ZZZ_DOMAIN"),
        "parent_item" => __("Nadřazená kategorie", "ZZZ_DOMAIN"),
        "parent_item_colon" => __("Nadřazená kategorie:", "ZZZ_DOMAIN"),
        "new_item_name" => __("Nová kategorie", "ZZZ_DOMAIN"),
        "add_new_item" => __("Přidat novou kategorii", "ZZZ_DOMAIN"),
        "edit_item" => __("Upravit kategorii", "ZZZ_DOMAIN"),
        "update_item" => __("Aktualizovat kategorii", "ZZZ_DOMAIN"),
        "view_item" => __("Zobrazit kategorii", "ZZZ_DOMAIN"),
        "separate_items_with_commas" => __("Oddělte kategorie čárkami", "ZZZ_DOMAIN"),
        "add_or_remove_items" => __("Přidat nebo odebrat kategorie", "ZZZ_DOMAIN"),
        "choose_from_most_used" => __("Vybrat z nejpouživanějších", "ZZZ_DOMAIN"),
        "popular_items" => __("Populární kategorie", "ZZZ_DOMAIN"),
        "search_items" => __("Hledat kategorie", "ZZZ_DOMAIN"),
        "not_found" => __("Nenalezeno", "ZZZ_DOMAIN"),
        "no_terms" => __("Žádné kategorie", "ZZZ_DOMAIN"),
        "items_list" => __("Seznam kategorií", "ZZZ_DOMAIN"),
        "items_list_navigation" => __("Seznam kategorií menu", "ZZZ_DOMAIN"),
    ];
    $args = [
        "labels" => $labels,
        "hierarchical" => true,
