...
function kt_zzz_register_reference_post_type() {
    $postLabels = array(
        ...
        "add_new" => __("Přidat referenci", "ZZZ_ADMIN_DOMAIN"),
        "add_new_item" => __("Přidat novou referenci", "ZZZ_ADMIN_DOMAIN"),
        "new_item" => __("Nová reference", "ZZZ_ADMIN_DOMAIN"),
        "edit_item" => __("Změnit referenci", "ZZZ_ADMIN_DOMAIN"),
        ...
        "parent_item_colon" => __("Rodičovská reference:", "ZZZ_ADMIN_DOMAIN"),
        "not_found" => __("Žádné reference nenalezeny.", "ZZZ_ADMIN_DOMAIN"),
        "not_found_in_trash" => __("Žádné reference v koši.", "ZZZ_ADMIN_DOMAIN"),
    );
    $postArgs = array(
        "labels" => $postLabels,
        "public" => true,
