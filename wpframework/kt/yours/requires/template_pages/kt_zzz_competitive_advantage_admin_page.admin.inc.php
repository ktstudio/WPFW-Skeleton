...
$template = new KT_Custom_Metaboxes_Page(
    __("Správa a nastavení konkurečních výhod", "ZZZ_ADMIN_DOMAIN"), __("Konkureční výhody", "ZZZ_ADMIN_DOMAIN"), "manage_categories", KT_ZZZ_Competitive_Advantage_Model::PREFIX, "dashicons-awards", 30
);

// --- definice crud listu ------------------

$crudList = KT_Catalog_Base_Config::getCatalogCrudList(
    "KT_ZZZ_Competitive_Advantage_Model", KT_ZZZ_Competitive_Advantage_Model::TABLE, __("Přehled konkurečních výhod", "ZZZ_ADMIN_DOMAIN")
);
